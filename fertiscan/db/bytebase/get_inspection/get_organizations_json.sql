...
DROP FUNCTION IF EXISTS "fertiscan_0.0.19".get_organizations_information_json(label_id_value uuid);
CREATE OR REPLACE FUNCTION "fertiscan_0.0.19".get_organizations_information_json(
label_id_value uuid)
RETURNS jsonb 
LANGUAGE plpgsql
AS $function$
...
DROP FUNCTION IF EXISTS "fertiscan_0.0.19".get_organizations_json();
CREATE OR REPLACE FUNCTION "fertiscan_0.0.19".get_organizations_json()
RETURNS jsonb
LANGUAGE plpgsql
AS $function$
DECLARE
