...
DROP TRIGGER IF EXISTS guaranteed_creation ON "fertiscan_0.0.14".guaranteed;
CREATE TRIGGER guaranteed_creation
AFTER INSERT ON "fertiscan_0.0.14".guaranteed
FOR EACH ROW
...
DROP TRIGGER IF EXISTS guaranteed_deletion ON "fertiscan_0.0.14".guaranteed;
CREATE TRIGGER guaranteed_deletion
AFTER DELETE ON "fertiscan_0.0.14".guaranteed
FOR EACH ROW
