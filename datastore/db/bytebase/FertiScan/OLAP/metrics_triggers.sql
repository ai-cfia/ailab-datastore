...
DROP TRIGGER IF EXISTS metrics_creation ON "fertiscan_0.0.14".metric;
CREATE TRIGGER metrics_creation
AFTER INSERT ON "fertiscan_0.0.14".metric
FOR EACH ROW
...
DROP TRIGGER IF EXISTS metrics_deletion ON "fertiscan_0.0.14".metric;
CREATE TRIGGER metrics_deletion
AFTER DELETE ON "fertiscan_0.0.14".metric
FOR EACH ROW
