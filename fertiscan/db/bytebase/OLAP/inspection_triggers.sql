...
BEGIN
    IF (TG_OP = 'INSERT') THEN
        IF (NEW.id IS NOT NULL) AND (NEW.label_info_id IS NOT NULL) THEN
        	-- Time Dimension
            INSERT INTO "fertiscan_0.0.14".time_dimension (
            ...
            INSERT INTO "fertiscan_0.0.14".inspection_factual (
...
DROP TRIGGER IF EXISTS inspection_creation ON "fertiscan_0.0.14".inspection;
CREATE TRIGGER inspection_creation
AFTER INSERT ON "fertiscan_0.0.14".inspection
FOR EACH ROW
...
DROP TRIGGER IF EXISTS inspection_update ON "fertiscan_0.0.14".inspection;
...
BEGIN
    IF (TG_OP = 'DELETE') THEN
        ...
        DELETE FROM "fertiscan_0.0.14".inspection_factual 
...
DROP TRIGGER IF EXISTS inspection_deletion ON "fertiscan_0.0.14".inspection;
