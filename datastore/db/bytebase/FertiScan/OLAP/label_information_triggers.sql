...
BEGIN
    IF (TG_OP = 'INSERT') THEN
        ...
        INSERT INTO "fertiscan_0.0.13"."label_dimension" (
...
DROP TRIGGER IF EXISTS label_information_creation ON "fertiscan_0.0.13".label_information;
CREATE TRIGGER label_information_creation
AFTER INSERT ON "fertiscan_0.0.13".label_information
FOR EACH ROW
...
DROP TRIGGER IF EXISTS label_information_update ON "fertiscan_0.0.13".label_information;
CREATE TRIGGER label_information_update
BEFORE UPDATE ON "fertiscan_0.0.13".label_information
FOR EACH ROW
...
BEGIN
    IF (TG_OP = 'DELETE') THEN
        ...
        DELETE FROM "fertiscan_0.0.13"."label_dimension" 
...
DROP TRIGGER IF EXISTS label_information_deletion ON "fertiscan_0.0.13".label_information;
