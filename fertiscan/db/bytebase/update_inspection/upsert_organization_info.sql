...
DROP FUNCTION IF EXISTS "fertiscan_0.0.19".upsert_organization_info(jsonb, uuid);
CREATE OR REPLACE FUNCTION "fertiscan_0.0.19".upsert_organization_info(input_org_info jsonb, label_info_id uuid)
RETURNS jsonb AS $$
DECLARE
    record jsonb;
    address_str TEXT;
