...
DROP FUNCTION IF EXISTS "fertiscan_0.0.19".new_registration_number(TEXT, UUID,BOOLEAN, TEXT, BOOLEAN);
CREATE OR REPLACE FUNCTION "fertiscan_0.0.19".new_registration_number(
    identifier TEXT,
    label_info_id UUID,
