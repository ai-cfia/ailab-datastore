...
data=(brassicaNapus[0], brassicaNapus[1],
      brassicaJunsea[0], brassicaJunsea[1],
      cirsiumArvense[0], cirsiumArvense[1],
      cirsiumVulgare[0], cirsiumVulgare[1],
      carduusNutans[0], carduusNutans[1],
      bromusSecalinus[0], bromusSecalinus[1],
      bromusHordeaceus[0], bromusHordeaceus[1],
      bromusJaponicus[0], bromusJaponicus[1],
      loliumTemulentum[0], loliumTemulentum[1],
      solanumCarolinense[0], solanumCarolinense[1],
      solanumNigrum[0], solanumNigrum[1],
      solanumRostratum[0], solanumRostratum[1],
      ambrosiaArtemisiifolia[0], ambrosiaArtemisiifolia[1],
      ambrosiaTrifida[0], ambrosiaTrifida[1],
      Ambrosiapsilostachya[0], Ambrosiapsilostachya[1])
