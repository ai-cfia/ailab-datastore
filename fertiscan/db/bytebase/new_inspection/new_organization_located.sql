...
DROP FUNCTION IF EXISTS "fertiscan_0.0.19".new_organization_located(TEXT, TEXT, TEXT, TEXT, BOOLEAN, UUID, BOOLEAN);
CREATE OR REPLACE FUNCTION "fertiscan_0.0.19".new_organization_info_located(
    name TEXT,
    address_str TEXT,
    website TEXT,
    phone_number TEXT,
