drOp FUNCTION IF EXISTS "fertiscan_0.0.19".new_label_information(TEXT, TEXT, TEXT,  FLOAT, FLOAT, FLOAT, TEXT, TEXT, BOOLEAN, UUID, UUID);
CREATE OR REPLACE FUNCTION "fertiscan_0.0.19".new_label_information(
    name TEXT,
    lot_number TEXT,
    npk TEXT,
    n FLOAt,
