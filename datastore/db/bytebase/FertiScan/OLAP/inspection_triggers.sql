...
DROP TRIGGER IF EXISTS inspection_creation ON "fertiscan_0.0.13".inspection;
CREATE TRIGGER inspection_creation
AFTER INSERT ON "fertiscan_0.0.13".inspection
FOR EACH ROW
...
DROP TRIGGER IF EXISTS inspection_update ON "fertiscan_0.0.13".inspection;
...
BEGIN
    IF (TG_OP = 'DELETE') THEN
        ...
        DELETE FROM "fertiscan_0.0.13".inspection_factual 
...
DROP TRIGGER IF EXISTS inspection_deletion ON "fertiscan_0.0.13".inspection;
