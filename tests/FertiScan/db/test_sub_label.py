...
class test_sub_label(unittest.TestCase):
    def setUp(self):
        ...
        self.sub_type_id = sub_label.new_sub_type(self.cursor, self.type_fr, self.type_en)
    ...
    def test_new_sub_label(self):
        sub_label_id = sub_label.new_sub_label(self.cursor, self.text_fr, self.text_en,self.label_id, self.sub_type_id)
    ...
    def test_get_all_sub_label(self):
        ...
        sub_label_id = sub_label.new_sub_label(self.cursor, self.text_fr, self.text_en,self.label_id, self.sub_type_id)
        sub_id = sub_label.new_sub_label(self.cursor, other_fr, other_en,self.label_id, self.sub_type_id)
