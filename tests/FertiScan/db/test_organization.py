...
class test_organization(unittest.TestCase):
    ...
    def test_new_organization(self):
        organization_id = organization.new_organization(self.cursor, self.name, self.website, self.phone)
        self.assertTrue(validator.is_valid_uuid(organization_id))
        
    def test_update_organization(self):
        organization_id = organization.new_organization(self.cursor, self.name, self.website, self.phone)
        organization.update_organization(self.cursor, organization_id, self.name, self.website, self.phone,self.location_id)
    ...
    def test_get_full_organization(self):
        organization_id = organization.new_organization(self.cursor, self.name, self.website, self.phone,self.location_id)
        organization_data = organization.get_full_organization(self.cursor, organization_id)
