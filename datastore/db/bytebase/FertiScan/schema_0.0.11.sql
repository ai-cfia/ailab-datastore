--Schema creation "fertiscan_0.0.11"
DO
$do$
BEGIN
IF (EXISTS (SELECT 1 FROM information_schema.schemata WHERE schema_name = 'fertiscan_0.0.11')) THEN


    CREATE EXTENSION IF NOT EXISTS "uuid-ossp";

    CREATE TABLE "fertiscan_0.0.11"."users" (
    ...
    CREATE TYPE "fertiscan_0.0.11".LANGUAGE AS ENUM ('fr', 'en');

    CREATE TABLE "fertiscan_0.0.11"."picture_set" (
    "id" uuid NOT NULL DEFAULT uuid_generate_v4() PRIMARY KEY,
    "picture_set" json NOT NULL,
    "owner_id" uuid NOT NULL REFERENCES "fertiscan_0.0.11".users(id),
    "upload_date" date NOT NULL DEFAULT current_timestamp,
    "name" text
    );
        
    alter table "fertiscan_0.0.11".users ADD "default_set_id" uuid REFERENCES "fertiscan_0.0.11".picture_set(id);

    CREATE TABLE "fertiscan_0.0.11"."picture" (
    "id" uuid NOT NULL DEFAULT uuid_generate_v4() PRIMARY KEY,
    "picture" json NOT NULL,
    "nb_obj" int,
    "picture_set_id" uuid NOT NULL REFERENCES "fertiscan_0.0.11".picture_set(id),
    "verified" boolean NOT NULL DEFAULT false,
    "upload_date" TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP
    );

    CREATE TABLE "fertiscan_0.0.11"."province" (
    "id" SERIAL PRIMARY KEY,
    "name" text UNIQUE NOT NULL
    );

    CREATE TABLE "fertiscan_0.0.11"."region" (
    "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    "province_id" int REFERENCES "fertiscan_0.0.11".province(id),
    "name" text NOT NULL
    );

    CREATE TABLE "fertiscan_0.0.11"."location" (
    "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    "name" text,
    "address" text NOT NULL,
    "region_id" uuid References "fertiscan_0.0.11".region(id)
    );    
    
    CREATE TABLE "fertiscan_0.0.11"."organization_information" (
        "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
        "name" text NOT NULL,
        "website" text,
        "phone_number" text,
    ...
    "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    "information_id" uuid REFERENCES "fertiscan_0.0.11".organization_information(id),
    "main_location_id" uuid REFERENCES "fertiscan_0.0.11".location(id)
    );


    Alter table "fertiscan_0.0.11".location ADD "owner_id" uuid REFERENCES "fertiscan_0.0.11".organization(id);

    CREATE TABLE "fertiscan_0.0.11"."sample" (
    "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    "number" uuid,
    "collection_date" date,
    "location" uuid REFERENCES "fertiscan_0.0.11".location(id)
    );

    CREATE TABLE "fertiscan_0.0.11"."unit" (
    "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    "unit" text NOT NULL,
    "to_si_unit" float
    );

    CREATE TABLE "fertiscan_0.0.11"."element_compound" (
    "id" SERIAL PRIMARY KEY,
    "number" int NOT NULL,
    ...
    CREATE TABLE "fertiscan_0.0.11"."label_information" (
    "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    "product_name" text,
    "lot_number" text,
    "npk" text,
    ...
    CREATE TABLE "fertiscan_0.0.11"."metric" (
    "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    ...
    CREATE TABLE "fertiscan_0.0.11"."sub_type" (
        "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    ...
    CREATE TABLE "fertiscan_0.0.11"."specification" (
    "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    "humidity" float,
    "ph" float,
    "solubility" float,
    ...
    CREATE TABLE "fertiscan_0.0.11"."sub_label" (
        "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
        "text_content_fr" text NOT NULL DEFAULT '',
        "text_content_en" text NOT NULL DEFAULT '',
        "label_id" uuid NOT NULL REFERENCES "fertiscan_0.0.11"."label_information" ("id"),
        "edited" boolean NOT NULL,
        "sub_type_id" uuid NOT NULL REFERENCES "fertiscan_0.0.11"."sub_type" ("id")
    );

    CREATE TABLE "fertiscan_0.0.11"."micronutrient" (
    "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    "read_name" text NOT NULL,
    "value" float NOT NULL,
    "unit" text NOT NULL,
    "element_id" int REFERENCES "fertiscan_0.0.11".element_compound(id),
    "label_id" uuid REFERENCES "fertiscan_0.0.11".label_information(id),
    "edited" boolean,
    "language" "fertiscan_0.0.11".LANGUAGE
    );

    CREATE TABLE "fertiscan_0.0.11"."guaranteed" (
    "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    "read_name" text NOT NULL,
    "value" float NOT NULL,
    "unit" text NOT NULL,
    ...
    CREATE TABLE "fertiscan_0.0.11"."ingredient" (
    "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    "organic" boolean,
    "active" boolean,
    "name" text NOT NULL,
    ...
    CREATE TABLE "fertiscan_0.0.11"."inspection" (
    "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    "verified" boolean DEFAULT false,
    "upload_date" timestamp DEFAULT CURRENT_TIMESTAMP,
    "updated_at" timestamp DEFAULT CURRENT_TIMESTAMP,
    "inspector_id" uuid NOT NULL REFERENCES "fertiscan_0.0.11".users(id),
    "label_info_id" uuid REFERENCES "fertiscan_0.0.11".label_information(id),
    "sample_id" uuid REFERENCES "fertiscan_0.0.11".sample(id),
    "picture_set_id" uuid REFERENCES "fertiscan_0.0.11".picture_set(id)
    );

    CREATE TABLE "fertiscan_0.0.11"."fertilizer" (
    "id" uuid PRIMARY KEY DEFAULT uuid_generate_v4(),
    "name" text UNIQUE NOT NULL,
    "registration_number" text,
    "upload_date" timestamp DEFAULT CURRENT_TIMESTAMP,
    "update_at" timestamp DEFAULT CURRENT_TIMESTAMP,
    "latest_inspection_id" uuid REFERENCES "fertiscan_0.0.11".inspection(id),
    "owner_id" uuid REFERENCES "fertiscan_0.0.11".organization(id)
    );

    Alter table "fertiscan_0.0.11".inspection ADD "fertilizer_id" uuid REFERENCES "fertiscan_0.0.11".fertilizer(id);
    ...
    BEFORE UPDATE ON  "fertiscan_0.0.11".users
    FOR EACH ROW
    ...
    BEFORE UPDATE ON  "fertiscan_0.0.11".inspection
    FOR EACH ROW
    ...
    BEFORE UPDATE ON  "fertiscan_0.0.11".fertilizer
    FOR EACH ROW
...
--WEIGHT
    ...
    LOOP
	   ...
	   -- If unit_id is null, the unit does not exist
	    ...
	    VALUES (value_float, unit_id, FALSE,'weight'::"fertiscan_0.0.11".metric_type,label_id);
	 END LOOP;
-- Weight end
...
--DENSITY
	...
	IF read_value IS NOT NULL THEN
	    ...
	    END IF;
	   	 ...
	   	 -- Insert into metric for weight
	    INSERT INTO metric (value, unit_id, edited,metric_type_id,label_id)
	    VALUES (value_float, unit_id, FALSE,'density'::"fertiscan_0.0.11".metric_type,label_id);
	END IF;
-- DENSITY END
...
--VOLUME
	...
	IF read_value IS NOT NULL THEN
	    ...
	    END IF;
	   	 ...
	   	 -- Insert into metric for weight
	    INSERT INTO metric (value, unit_id, edited,metric_type_id,label_id)
	    VALUES (value_float, unit_id, FALSE,'volume'::"fertiscan_0.0.11".metric_type,label_id);
	END IF;
-- Volume end
	...
	LOOP
		...
		LOOP
			...
			VALUES (
				...
				FALSE,
				ingredient_language::"nachet_0.0.11".language,
				label_id
			);
		END LOOP;
	END LOOP;
