...
DROP TRIGGER IF EXISTS specification_creation ON "fertiscan_0.0.13".specification;
CREATE TRIGGER specification_creation
AFTER INSERT ON "fertiscan_0.0.13".specification
FOR EACH ROW
...
DROP TRIGGER IF EXISTS specification_deletion ON "fertiscan_0.0.13".specification;
CREATE TRIGGER specification_deletion
AFTER DELETE ON "fertiscan_0.0.13".specification
FOR EACH ROW
